...
})({"8x7q7":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "31770843a0692d03";
"use strict";
...
},{}],"4BYM7":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Function to save cart items
parcelHelpers.export(exports, "saveCartItem", ()=>saveCartItem);
...
async function saveCartItem(userId, cartItem) {
    const cartRef = (0, _firestore.doc)(db, "users", userId, "cart", cartItem.id);
    await (0, _firestore.setDoc)(cartRef, cartItem);
}
async function loadCart(userId) {
    const cartRef = (0, _firestore.collection)(db, "users", userId, "cart");
    const cartSnapshot = await (0, _firestore.getDocs)(cartRef);
    const cart = cartSnapshot.docs.map((doc)=>doc.data());
    console.log("Cart items:", cart);
}

},{"firebase/app":"aM3Fo","firebase/auth":"79vzg","firebase/firestore":"8A4BC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8x7q7","4BYM7"], "4BYM7", "parcelRequire94c2")

//# sourceMappingURL=index.a0692d03.js.map
