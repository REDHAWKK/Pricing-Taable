...
})({"l6HLH":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d52b9770616af81f";
"use strict";
...
},{}],"aat4k":[function(require,module,exports,__globalThis) {
...
function signUpUser(email, password, additionalData) {
    (0, _auth.createUserWithEmailAndPassword)(auth, email, password).then(async (userCredential)=>{
        const user = userCredential.user;
        // Save additional data to Firestore
        await (0, _firestore.setDoc)((0, _firestore.doc)(db, "users", user.uid), additionalData);
...
},{"firebase/app":"aM3Fo","firebase/auth":"79vzg","firebase/firestore":"8A4BC"}]},["l6HLH","aat4k"], "aat4k", "parcelRequire94c2")

//# sourceMappingURL=Signup.616af81f.js.map
