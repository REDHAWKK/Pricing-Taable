...
})({"eiJWm":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "0dc376fb78f5a4b2";
"use strict";
...
},{}],"d6dqH":[function(require,module,exports,__globalThis) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (userId) displayFirstName(userId);
    else console.error("No user ID found in localStorage.");
});
const addDataToHTML = ()=>{
    listProductHTML.innerHTML = '';
    if (listProducts.length > 0) listProducts.forEach((product)=>{
...
const addToCart = (product_id)=>{
    ...
    else if (positionThisProductInCart < 0) carts.push({
        product_id: product_id,
        quantity: 1
    });
    else carts[positionThisProductInCart].quantity += 1; // Increment quantity by 1
    addCartToHTML();
    addCartToMemory();
};
...
const initApp = ()=>{
    fetch('javascript/products.json').then((response)=>response.json()).then((data)=>{
        listProducts = data;
        addDataToHTML();
...
},{}]},["eiJWm","d6dqH"], "d6dqH", "parcelRequire94c2")

//# sourceMappingURL=Shop.78f5a4b2.js.map
